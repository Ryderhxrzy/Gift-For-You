...
export default function ForYouPage() {
  ...
  return (
    <main className="relative h-screen w-full bg-[#fffef4] overflow-hidden">
      {/* Background Grid Pattern (Border-border) with very low opacity */}
      <div
      ...
      <div className="absolute inset-x-8 inset-y-8 overflow-y-auto overflow-x-hidden z-10 custom-scrollbar">
      ...
      <div className="absolute bottom-15 right-20 z-[60]">
        <MusicPlayer />
      </div>
    </main>
  );
