      ...
      >
        <div className="relative p-10 md:p-16 text-center">
           ...
           <div className="space-y-8 mb-16 relative">
              ...
              <div className="font-handwritten text-2xl md:text-3xl text-slate-700 leading-relaxed max-w-2xl mx-auto space-y-6">
                 <p>
                    Happy happy birthday sa'yo, mahal! Sobrang saya ko na nakasama kitang icelebrate ang napaka-importanteng araw na 'to. Thank you for being part of my life, for making every day brighter, and for being exactly the person you are.
                 </p>
                 <p>
                    Lahat ng mga gala natin, mula QC Circle, Intramuros, hanggang Antipolo—bawat segundo doon ay treasures sa puso ko. Sana ay mas marami pa tayong mapuntahan na lugar at mas marami pa tayong mabubuong memories na magkasama.
                 </p>
                 <p>
                    Always remember na nandito lang ako parati para sa'yo, susuportahan kita sa lahat ng dreams mo. You deserve all the love and happiness in the world. I love you so much, more than words can say! ❤️
                 </p>
              </div>
